...
public class FontFamilyChooser extends javax.swing.JFrame {
    ...
    public FontFamilyChooser() {
        initComponents();
        loadComboBox();
        String FontFamily = jComboBox1.getSelectedItem().toString();
        jLabel2.setFont(new Font(FontFamily, Font.PLAIN, 13));    
        jLabel3.setFont(new Font(FontFamily, Font.PLAIN, 13));    
        jLabel2.setText("The text is in " + FontFamily);
