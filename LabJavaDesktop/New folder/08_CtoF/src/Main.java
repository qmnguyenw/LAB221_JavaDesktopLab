...
//    String NUMBER_VALID = "^[0-9]$";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!checkNumber(input)) {
            JOptionPane.showMessageDialog(null, "Input must be a correct form of positive number!!!");
            jTextField1.setText("");
        }else{
            double converterNumber = Double.parseDouble(jTextField1.getText().trim()) * 33.8;
